...
def is_always_roll(strategy, goal=GOAL):
    ...
    score0 = 0
    score1 = 0
    k = strategy(score0, score1)
    for score0 in range(goal):
        for score1 in range(goal):
            if k != strategy(score0, score1):
                return False
    return True
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    for num_rolls in range(1, 11):
        ...
        if score > highest_score:
            highes_numrolls, highest_score = num_rolls, score
    return highes_numrolls
    # END PROBLEM 9
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    total_score = score + threshold
    if square_update(0, score, opponent_score, dice=six_sided) > total_score:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
