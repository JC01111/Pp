...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        # Two cases: bee and ThrowerAnt at the same place
        # If not at the same place, put a random bee
        curr_place = self.place
        while not curr_place.is_hive:
            if curr_place.bees: #If they are at the same place
                return random_bee(curr_place.bees)
            else:
                curr_place = curr_place.entrance #Go to next place
        return None
        # END Problem 3 and 4
